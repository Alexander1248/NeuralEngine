...
public class MatMul extends Instruction {
    public MatMul(GpuExecutor executor) {
        super(executor);
    }
    ...
    public void compute(String... args) {
        ...
        startGPUTask("mtxOperations.matrixMul",
                in2.width(), in1.height(), 1,
    ...
    public void addOutputVariable(String... args) {
        ...
        if (hasVariable(args[0])
                && !variableSizeIsEqual(args[0], var2.width(), var1.height()))
